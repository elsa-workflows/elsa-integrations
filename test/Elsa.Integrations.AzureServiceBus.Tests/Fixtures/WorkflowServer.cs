...
using Elsa.Integrations.AzureServiceBus.Tests.Extensions;
...
[UsedImplicitly]
public class WorkflowServer(Infrastructure infrastructure, string url) : WorkflowServerFactory<WorkflowServer>
{
